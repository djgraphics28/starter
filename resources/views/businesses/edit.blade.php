                            ...
                            <form action="{{ route('businesses.update', $business) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" id="code"
                                        ...
                                        value="{{ old('code', $business->code) }}" required>
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror">{{ old('address', $business->address) }}</textarea>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <div class="mt-3">
                                        <img id="logo-preview" src="{{ $business->getFirstMediaUrl('business-logo') }}" alt="Logo Preview"
                                            class="img-thumbnail {{ !$business->getFirstMediaUrl('business-logo') ? 'd-none' : '' }}"
